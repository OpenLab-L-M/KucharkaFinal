...
{
    /// <inheritdoc />
    public partial class neger : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ingrediencie = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Cas = table.Column<int>(type: "int", nullable: true),
                    Veganske = table.Column<bool>(type: "bit", nullable: true),
                    Vegetarianske = table.Column<bool>(type: "bit", nullable: true),
                    NizkoKaloricke = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    postupy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountOfDisslikes = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    RecenziaId = table.Column<int>(type: "int", nullable: false),
